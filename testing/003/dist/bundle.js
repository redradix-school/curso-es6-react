...
var PAUSE_TIMER = exports.PAUSE_TIMER = 'PAUSE_TIMER';
var RESUME_TIMER = exports.RESUME_TIMER = 'RESUME_TIMER';
var TIMER_TICK = exports.TIMER_TICK = 'TIMER_TICK';
...
var UPDATE_LAPS = exports.UPDATE_LAPS = 'UPDATE_LAPS';
...
var _timer = __webpack_require__(72);

var _timer2 = _interopRequireDefault(_timer);

var _status = __webpack_require__(73);

var _status2 = _interopRequireDefault(_status);

var _laps = __webpack_require__(75);

var _laps2 = _interopRequireDefault(_laps);
...
var store = (0, _redux.createStore)((0, _redux.combineReducers)({ timer: _timer2.default, status: _status2.default, laps: _laps2.default }), composeEnhancers((0, _redux.applyMiddleware)(_reduxThunk2.default)));
...
exports.default = function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { time: 0, id: undefined };
  var action = arguments[1];
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actionTypes.START_TIMER:
      return 'running';
    case _actionTypes.STOP_TIMER:
      return 'stopped';
    case _actionTypes.PAUSE_TIMER:
      return 'paused';
    case _actionTypes.RESUME_TIMER:
      return 'running';
    default:
      return state;
  }
...
var _stopwatch = __webpack_require__(78);

var _stopwatch2 = _interopRequireDefault(_stopwatch);

var _lapList = __webpack_require__(79);

var _lapList2 = _interopRequireDefault(_lapList);

var _resetLapsButton = __webpack_require__(80);

var _resetLapsButton2 = _interopRequireDefault(_resetLapsButton);

var _actionCreators = __webpack_require__(81);

var _actionCreators2 = __webpack_require__(82);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'timer' },
          _react2.default.createElement(_stopwatch2.default, { timer: timer, status: status, laps: laps,
            updateLaps: this.props.updateLaps,
            pauseTimer: this.props.pauseTimer,
            resumeTimer: this.props.resumeTimer,
            stopTimer: this.props.stopTimer,
            startTimer: this.props.startTimer }),
          _react2.default.createElement(_lapList2.default, { laps: laps, updateLaps: this.props.updateLaps }),
          _react2.default.createElement(_resetLapsButton2.default, { onClick: function onClick() {
              return _this2.props.updateLaps([]);
            } })
        )
      );
    }
...
var mapDispatchToProps = {
  startTimer: _actionCreators.startTimer,
  stopTimer: _actionCreators.stopTimer,
  pauseTimer: _actionCreators.pauseTimer,
  resumeTimer: _actionCreators.resumeTimer,
  updateLaps: _actionCreators2.updateLaps
};
...
var Stopwatch = function (_React$Component) {
  ...
  _createClass(Stopwatch, [{
    ...
    value: function start() {
      var startTimer = this.props.startTimer;
    ...
    value: function pause() {
      var pauseTimer = this.props.pauseTimer;
    ...
    value: function resume() {
      var resumeTimer = this.props.resumeTimer;
    ...
    key: "stop",
    value: function stop() {
      var stopTimer = this.props.stopTimer;
    ...
    value: function lap() {
      var _props = this.props,
          updateLaps = _props.updateLaps,
          laps = _props.laps,
          timer = _props.timer;

      updateLaps([].concat(_toConsumableArray(laps), [timer]));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "button",
            { className: "button-simple", onClick: this.start,
              disabled: status !== 'stopped' && 'disabled' },
            "Start"
          ),
          status === 'paused' ? _react2.default.createElement(
            "button",
            { className: "button-simple", onClick: this.resume },
            "Resume"
          ) : _react2.default.createElement(
            "button",
            { className: "button-simple", disabled: status !== 'running' && 'disabled',
              onClick: this.pause },
            "Pause"
          ),
          _react2.default.createElement(
            "button",
            { className: "button-simple", onClick: this.stop,
              disabled: status === 'stopped' && 'disabled' },
            "Stop"
          ),
          _react2.default.createElement(
            "button",
            { className: "button-simple", onClick: this.lap,
...
var LapList = function (_React$Component) {
  _inherits(LapList, _React$Component);

  function LapList() {
    _classCallCheck(this, LapList);

    return _possibleConstructorReturn(this, (LapList.__proto__ || Object.getPrototypeOf(LapList)).apply(this, arguments));
  }

  _createClass(LapList, [{
    key: "deleteLap",
    value: function deleteLap(index) {
      var _props = this.props,
          laps = _props.laps,
          updateLaps = _props.updateLaps;
    ...
    key: "renderLapItem",
    value: function renderLapItem(lap, index) {
      var _this2 = this;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { onClick: function onClick() {
              return _this2.deleteLap(index);
            }, className: "button-icon" },
          _react2.default.createElement("span", { className: "icon icon-x-circle" })
        )
      );
    }
  }, {
    ...
    value: function render() {
      ...
      var items = laps.map(function (lap, i) {
        return _this3.renderLapItem(lap, i);
      });
      return _react2.default.createElement(
        "div",
...
var ResetLapsButton = function (_React$Component) {
  _inherits(ResetLapsButton, _React$Component);

  function ResetLapsButton() {
    _classCallCheck(this, ResetLapsButton);

    return _possibleConstructorReturn(this, (ResetLapsButton.__proto__ || Object.getPrototypeOf(ResetLapsButton)).apply(this, arguments));
  }

  _createClass(ResetLapsButton, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        "div",
        ...
        _react2.default.createElement(
          "button",
          { className: "button-error", onClick: this.props.onClick },
          _react2.default.createElement("span", { className: "icon icon-refresh-ccw" }),
          _react2.default.createElement(
            "span",
            { className: "text" },
            "Reset"
  ...
  return ResetLapsButton;
}(_react2.default.Component);

exports.default = ResetLapsButton;
...
exports.timerTick = exports.resumeTimer = exports.pauseTimer = exports.stopTimer = exports.startTimer = undefined;
...
var startTimer = exports.startTimer = function startTimer() {
  return function (dispatch) {
    var id = setInterval(function () {
      return dispatch(timerTick());
    }, 10);
    dispatch({ type: _actionTypes.START_TIMER, payload: id });
  };
};

var stopTimer = exports.stopTimer = function stopTimer() {
  return function (dispatch, getState) {
    var state = getState().timer;
    clearInterval(state.id);
    dispatch({ type: _actionTypes.STOP_TIMER });
  };
};

var pauseTimer = exports.pauseTimer = function pauseTimer() {
  return function (dispatch, getState) {
    var state = getState().timer;
    clearInterval(state.id);
    dispatch({ type: _actionTypes.PAUSE_TIMER });
  };
};

var resumeTimer = exports.resumeTimer = function resumeTimer() {
  return function (dispatch) {
    var id = setInterval(function () {
      return dispatch(timerTick());
    }, 10);
    dispatch({ type: _actionTypes.RESUME_TIMER, payload: id });
  };
};

var timerTick = exports.timerTick = function timerTick() {
  return {
    type: _actionTypes.TIMER_TICK
  };
};
...
exports.updateLaps = undefined;

var _actionTypes = __webpack_require__(30);

var updateLaps = exports.updateLaps = function updateLaps(laps) {
  return {
    type: _actionTypes.UPDATE_LAPS,
    payload: laps
  };
};
