...
var HolaMundo = function (_React$Component) {
  _inherits(HolaMundo, _React$Component);

  function HolaMundo() {
    _classCallCheck(this, HolaMundo);

    return _possibleConstructorReturn(this, (HolaMundo.__proto__ || Object.getPrototypeOf(HolaMundo)).apply(this, arguments));
  }
...
window.onload = function () {
  return _reactDom2.default.render(_react2.default.createElement(HolaMundo), document.getElementById('app'));
};
